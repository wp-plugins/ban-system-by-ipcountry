...
<h1>Ban System</h1>
	...
	<a href="admin.php?page=bans" class="nav-tab">Home</a>
        ...
        <a href="admin.php?page=bansstat" class="nav-tab">Statistics</a>
                   ...
                   <table><tr><td>IP:</td><td><input type="text" name="ip" value="<?php if(isset($_GET['i'])){echo $_GET['i'];}  ?>"></td></tr>
                   <tr><td>Duration:</td><td><select name="duration">
                    ...
                    <tr><td></td><td><input type="submit" value="Add" class="button"></td></tr>
                                ...
                                <?php
                    if(isset($_POST['ip'])){
                    if($_POST['ip']==""){echo("<span style='color:red'>Pease fill the IP input!</span>");}else{
                    $date = new DateTime(date('m/d/Y H:i'));
                    $dur = $_POST['duration'];
                    if($dur == "1h"){$add = "+1 hours";}
                    ...
                    if($dur == "1y"){$add = "+365 days";}
                    if($dur == "p"){$add = "+999999 days";}
                    $date->modify($add);
    ...
    if($data->Country[$i]->name == $del){
      ...
      update_option('cnr', $g-1);
                ...
                if(isset($_POST['country'])){
                    if($_POST['country']==""){die("<br><span style='color:red'>Pease select a country!</span><br>");}
                ...
                echo 'Banned countries:<br><br>';
                        ...
                        $m=get_option('cnr');
        if($m==0){echo '<div style="color:grey;text-align:center;">No country banned yet!</div>';}else{
            $m=$m-1;
            echo '<table>';
        for($i=0; $i<=$m; $i++){
